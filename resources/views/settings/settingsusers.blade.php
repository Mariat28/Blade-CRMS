            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="email-right-box ml-0 ml-sm-4 ml-sm-0 ">
									<div class="row mb-5 align-items-center mt-3">
										<div class="col-lg-3 mb-4 mb-lg-0 ">
											<a class="btn btn-primary light  btn-block rounded " data-toggle="modal" data-target="#newuser">+ Add new User</a>
										</div>
										<div class="col-lg-9">
											<div class="card m-0 ">
														...
														<div class="col-md-5 mb-3 mb-md-0">
															<div class="media align-items-end">
																...
																<div class="media-body ml-1">
																	<p class="mb-1 fs-14">Total Users Accounts</p>
																	<h3 class="mb-0 font-w600 fs-20">129 Users</h3>
																</div>
															</div>
														</div>
													</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="table-responsive mt-0">
												<table id="example3" class="table display mb-4 fs-14">
													<thead>
														<tr>
															<th>
															...
															<td>
																<div class="checkbox mr-0 align-self-center">
																	<div class="custom-control custom-checkbox ">
																		...
																		<label class="custom-control-label"
																			for="customCheckBox27"></label>
																	</div>
																</div>
															</td>
															<td>#0012451</td>
															<td>21/11/2017</td>
															<td>Kassuja Mohammed</td>
															<td>+256 705 976941)</td>
															<td>Supervisor</td>


															<td>
																<div class="d-flex">
																	<a class="fa fa-eye mr-4 mt-1" width="25"
																		height="24" href="#"></a>
																	...
																	<a href="javascript:void(0);" class="ml-4">
																		<svg width="25" height="24" viewBox="0 0 25 24"
																			fill="none"
																			xmlns="http://www.w3.org/2000/svg">
																			<path d="M3.50195 5.99994H5.5156H21.6248"
																				stroke="#A0A0A0" stroke-width="2"
																				stroke-linecap="round"
																				stroke-linejoin="round" />
																			<path
