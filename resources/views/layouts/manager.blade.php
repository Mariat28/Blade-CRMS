				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon mm-show" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false" class="mm-show">
							<li><a href="{{route('managerdashboard')}}">Home</a></li>
							<li><a href="#">Applications</a></li>
							<li><a class="" href="{{route('managerviewcompanies')}}">
								<span class="nav-text">Companies</span>
							</a></li>
                            <li><a class="" href="{{route('managerviewadmins')}}">
								<span class="nav-text">Administrators</span>
							</a></li>
							<li>
								<a class="" href="{{route('managerviewsubscriptions')}}>
