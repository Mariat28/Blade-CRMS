...
<body>
				...
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon mm-show" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false" class="mm-show">
							...
							<li><a href="{{ route('agentopentickets') }}">Open Tickets</a></li>
							<li><a class="" href="{{ route('agentclosedtickets') }}">
    ...
    ***********************************-->
	...
	<script src="{{ URL::asset('js/dashboard/dashboard-1.js') }}"></script>
	 ...
	 <!-- Summernote -->
	 <script src="{{ URL::asset('vendor/summernote/js/summernote.min.js') }}"></script>
	 <!-- Summernote init -->
	 <script src="{{ URL::asset('js/plugins-init/summernote-init.js') }}"></script>
