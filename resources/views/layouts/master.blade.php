    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
			...
			<p style="margin-left: 60px;">{{session('company')->name}}</p>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item">
								<a class="btn btn-primary  d-md-block d-none" href="/settings">
											...
											<li>
												<div class="timeline-panel">
													...
													<div class="media-body">
														<!--<h6 class="mb-1">Str::of($ticket->body)->limit(20) </h6>
														<small class="d-block">$ticket->created_at</small>-->
													</div>
												</div>
											</li>
										</ul>
									</div>
                                    <a class="all-notification" href="/tickets">See all tickets <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
							<li class="nav-item dropdown notification_dropdown">
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li class="{{ (request()->is('tickets') || request()->is('closedtickets')||request()->is('ticketdetails*') || request()->is('opentickets') || request()->is('pendingtickets')) ? 'mm-active' : '' }}"><a class="has-arrow ai-icon" href="{{ route('tickets',['ticketsCategory'=>'unassigned']) }}" aria-expanded="false">
                        <i  class="fas fa-chart-pie"></i>
