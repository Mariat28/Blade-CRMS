<div class="modal fade" id="newagent" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="basic-form">
                    ...
                    <form action="{{ route('addagent') }}" method="post" id="addagent">
                        @csrf
		  ...
		  <button type="submit" class="btn btn-primary" form="addagent">Add Agent</button>
		</div>
        </div>
    </div>
</div>