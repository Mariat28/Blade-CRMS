							...
							<div class="card-body">
								<div class="d-sm-flex d-block pb-sm-3 align-items-end">
									<div class="mr-auto pr-3 mb-2 mb-sm-0">
										<span class="text-white fs-20 font-w200 d-block mb-sm-3 mb-2">Tickets created
											Today</span>
										<h2 class="fs-40 text-white mb-0">456,502<span class="fs-18 ml-2">tickets</span>
										</h2>
									</div>
								...
								<div class="progress mt-3 mb-4" style="height:15px;">
									<div class="progress-bar-striped progress-bar-animated"
										style="width: 86%; height:15px;" role="progressbar">
										<span class="sr-only">86% Complete</span>
									</div>
								</div>
								<p class="fs-12">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
									tempor incididunt ut labore et dolore magna aliqua. Ut enim ad mini</p>
								<a href="#" class="text-white">View detail<i
										class="las la-long-arrow-alt-right scale5 ml-3"></i></a>
							</div>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-header align-items-start pb-0 border-0">
										<div>
											<h4 class="fs-16 mb-0">Due Today</h4>
											<h6 class="fs-16 mb-0">451,509</h6>
											<span class="fs-12">Tickets</span>
										</div>
										<div class="dropdown">
											<a href="javascript:;" class="dropdown-toggle fs-12" data-toggle="dropdown"
												aria-expanded="false">
												This Week
											</a>
							...
							<div class="col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-header align-items-start pb-0 border-0">
										<div>
											<h4 class="fs-16 mb-0">Unresolved</h4>
											<h6 class="fs-16 mb-0">64,567</h6>
											<span class="fs-12">Tickets</span>
										</div>
										<div class="dropdown">
											<a href="javascript:;" class="dropdown-toggle fs-12" data-toggle="dropdown"
									...
									<div class="card-body pt-2">
										<div class="index-chart-point">
											...
											<ul class="index-chart-point-list">
												<li><i class="fa fa-stop text-danger"></i>Open</li>
												<li><i class="fa fa-stop text-success"></i> Resolved</li>
												<li><i class="fa fa-stop text-warning"></i> Over due</li>
												<li><i class="fa fa-stop text-info"></i> On hold</li>
											</ul>
										</div>
									</div>
								</div>
							...
							<div class="col-sm-6">
								<div class="card overflow-hidden">
									<div class="card-header align-items-start pb-0 border-0">
										<div>
											<h4 class="fs-16 mb-0">Unassigned</h4>
											<h6 class="fs-16 mb-0">$456,623</h6>
											<span class="fs-12">Tickets</span>
										</div>
										<div class="dropdown">
											<a href="javascript:;" class="dropdown-toggle fs-12" data-toggle="dropdown"
					...
					<div class="col-xl-9 col-xxl-8">
						<div class="card">
							<div class="card-header border-0 pb-0 d-sm-flex d-block">
								<div>
									<h4 class="mb-0 fs-20">Ticket Volume</h4>
								</div>
					...
					<div class="col-xl-3 col-xxl-4 col-md-6">
						<div class="card">
							<div class="card-header border-0 pb-0">
								<h4 class="fs-20">Most Active Group</h4>
								<div class="dropdown">
									<a href="javascript:;" class="dropdown-toggle fs-12" data-toggle="dropdown"
										aria-expanded="false">
										This Week
							...
							<div class="card-body">
								<div class="d-flex justify-content-between align-items-center bg-dark p-3 rounded">
									...
									<span class="text-white fs-14">215,523 tickets</span>
								</div>
